            ...
            @endif
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('paternaire.edit',$paternaire->id) }}" method="POST">
                        @csrf
                      <div class="form-group">
                        <label for="name">Nom du partenaire</label>
                        <input type="text" class="form-control" id="name" name="name" value="{{$paternaire->name}}" >
                      </div>
                      <div class="form-group">
                        <label for="activity_domain">Activite du domaine</label>
                        <input type="text" class="form-control" id="activity_domain" name="activity_domain" value="{{$paternaire->activity_domain}}" >
                      </div>
                      <div class="form-group">
                        <label for="address">Adresse du partenaire</label>
                        <input type="text" class="form-control" id="address" name="address"  value="{{$paternaire->address}}">
                      </div>
                      <div class="form-group">
                        <label for="contact">Contact du partenaire</label>
                        <input type="text" class="form-control" id="contact" name="contact" value="{{$paternaire->contact}}" >
                      </div>
